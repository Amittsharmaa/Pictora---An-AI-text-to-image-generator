    ...
    return (
        <div className='flex items-center justify-between py-4'>
            <Link to="/" className='flex gap-2'>
                {/* <img src={assets.logo_icon} className='w-28 sm:w-32 lg:w-40' /> */}
            ...
            <div>
                {user ?
                    <div className='flex items-center gap-2 sm:gap-3'>
                        <button onClick={() => navigate('/buycredits')} className='flex items-center gap-2 bg-gradient-to-r from-green-400 to-teal-500 px-4 sm:px-6 py-1.5 sm:py-3 rounded hover:scale-105 transition-all duration-700'>
                            <img className='w-5' src={assets.credit_star} />
                            <p className='text-xs sm:text-sm font-medium text-white-600'>Credit left: {credit}</p>
                        </button>
                    ...
                    <div className='flex items-center gap-2 sm:gap-5'>
                        <p className='cursor-pointer' onClick={() => navigate('/buycredits')}>Pricing</p>
